...
package org.anarchadia.quasar.util;
...
public class QuasarLogger {
    ...
    private static MutableText getText(int color) {
        return Text.literal(Formatting.GREEN + Quasar.mc.getSession().getUsername() + "@" + Quasar.MOD_NAME + Formatting.BLUE + " ~ $  ").styled(s -> s.withColor(color));
    }
}
