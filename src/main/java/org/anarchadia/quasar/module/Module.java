...
package org.anarchadia.quasar.module;

import org.anarchadia.quasar.Quasar;
import org.anarchadia.quasar.setting.Setting;
import org.anarchadia.quasar.setting.settings.KeybindSetting;
...
public abstract class Module {
    ...
    public void onEnable() {
        Quasar.getInstance().getEventBus().register(this);
    ...
    public void onDisable() {
        Quasar.getInstance().getEventBus().unregister(this);
        Quasar.getInstance().getConfigManager().save();
