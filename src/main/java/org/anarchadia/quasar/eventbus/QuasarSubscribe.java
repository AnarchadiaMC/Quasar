...
/**
 * QuasarSubscribe Annotation.
 * <p>
 * This annotation is used to subscribe methods to events in the Quasar event bus system. It allows
 ...
 * <p>
 * Note: For this annotation to work correctly, it needs to be processed by the Quasar EventBus
...
public @interface QuasarSubscribe {
