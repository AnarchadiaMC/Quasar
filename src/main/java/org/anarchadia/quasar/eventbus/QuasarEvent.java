...
public abstract class QuasarEvent {
    private boolean cancelled;
    private Era era;


    /**
     * Checks if the QuasarEvent is cancelled.
     *
    ...
    /**
     * Sets the cancellation status for the QuasarEvent.
     *
    ...
    /**
     * Retrieves the era associated with the current instance of the quasar event.
     *
     * @return Era instance indicates the timing of an event in the quasar system. It can be either a PRE-era (before the event happens)
    ...
    /**
     * Sets the era for the quasar event.
     *
     * @param era Enum representing the era of the event in the quasar system.
     */
    ...
    /**
     * The Era enum represents the timing of an event in a Quasar system.
